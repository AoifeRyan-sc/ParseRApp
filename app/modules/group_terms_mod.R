...
#             "  width: 100%;",
#             "}",
#             ".shiny-spinner-output-container > div {",
#             "  height: 100%;",
#             "  width: 100%;",
#             "}",
#             ".shiny-plot-output {",
...
#         icon_info = "Click here for Group Terms customisation"
#       ),
#       # Only show the plot area once the button has been pressed
#       div(
#         id = ns("plot_container"),
#         # style = "height:100%; width:100%",
#         shiny::conditionalPanel(
#           condition = "input.gt_action > 0", 
#           ns = ns,
#           shinycssloaders::withSpinner(
#             shiny::plotOutput(ns("gt_viz")), #, height = "100%", width = "100%"
#             fill = T
#           )
#         ),
#         # Show a placeholder message before button press
#         shiny::conditionalPanel(
#           condition = "input.gt_action == 0 || input.gt_action == null",
#           ns = ns,
#           tags$div(
#             style = "display: flex; justify-content: center; align-items: center; height: 100%; width: 100%;",
#             tags$p("Click the 'Plot' button to generate visualization")
#           )
#         )
#       )
#     ),
